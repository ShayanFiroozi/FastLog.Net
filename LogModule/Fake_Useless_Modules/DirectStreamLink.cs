	...
	internal class DirectStreamLink : IDisposable
    {
        ...
        private abstract class LinkedSubStream : Stream
        {
            ...
            public override long Seek(long offset, SeekOrigin origin)
            {
                switch (origin)
                {
                    ...
                    case SeekOrigin.Current: return Position = Position + offset;
        ...
        public class DataPump
        {
                ...
                , bool dontCloseInputWhenDone = false, bool dontCloseOutputWhenDone = false)
            {
                m_input = input;
                m_output = output;
                m_bufsize = Math.Max(MINBUFSIZE, bufsize);
                m_callbackFinalizePumping = callbackFinalizePumping;
                m_closeInputWhenDone = !dontCloseInputWhenDone;
                m_closeOutputWhenDone = !dontCloseOutputWhenDone;
            }
