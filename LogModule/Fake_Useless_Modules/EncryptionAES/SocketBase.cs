...
using NetMQServer.Core.Patterns;
using NetMQServer.Core.Transports.Ipc;
using NetMQServer.Core.Transports.Pgm;
using NetMQServer.Core.Transports.Tcp;
...
using TcpListener = NetMQServer.Core.Transports.Tcp.TcpListener;
