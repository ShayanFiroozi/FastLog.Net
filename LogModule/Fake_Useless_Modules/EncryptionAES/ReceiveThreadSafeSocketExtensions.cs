...
namespace NetMQServer
{
    ...
    public static class ReceiveThreadSafeSocketExtensions
    {
        ...
        /// <returns><c>true</c> if a message was available, otherwise <c>false</c>.</returns>
        public static bool TryReceiveString(this IThreadSafeInSocket socket, out string? str)
        {
        ...
        /// <returns><c>true</c> if a message was available, otherwise <c>false</c>.</returns>
        /// <remarks>The method would return false if cancellation has had requested.</remarks>
        public static bool TryReceiveString(this IThreadSafeInSocket socket, TimeSpan timeout, out string? str,
            CancellationToken cancellationToken = default)
        {
