...
namespace NetMQServer.Core.Mechanisms
{
    internal class CurveServerMechanism : CurveMechanismBase
    {
        ...
        private readonly byte[] m_cnSecretKey;
        private readonly byte[] m_cnPublicKey;
        private readonly byte[] m_cnClientKey;
        private readonly byte[] m_cookieKey;
        ...
        private PushMsgResult ProcessInitiate(ref Msg msg)
        {
            ...
            Span<byte> clientKey = new Span<byte>(initiatePlaintext, 0, 32);
