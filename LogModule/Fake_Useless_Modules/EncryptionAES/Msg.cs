...
namespace NetMQServer
{
    ...
    public struct Msg
    {
        ...
        /// </summary>
        /// <remarks>
        /// This value will be <c>null</c> if <see cref="MsgType"/> is <see cref="NetMQServer.MsgType.Uninitialised"/>,
        /// <see cref="NetMQServer.MsgType.Empty"/> or <see cref="NetMQServer.MsgType.Delimiter"/>.
        /// </remarks>
        [Obsolete("Use implicit casting to Span or Slice instead")]
