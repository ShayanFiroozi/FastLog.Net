...
**FastLog.Net** یک لاگر سریع و با عملکرد بالا برای دات نت
 
✔ سادگی در استفاده و توسعه , کدنویسی تمیز , قابلیت توسعه agent های لاگ , and also designed to be fully thread-safe.  
